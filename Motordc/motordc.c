...
char temp[16], temp1[16], temp2[16];
int potensio;
...
void putarberlawananarahjarumjam(){ 
    IN1 = 1; 
    IN2 = 0; 
    potensio = read_adc(0); 
    OCR1A = potensio; 
    lcd_gotoxy(0,0); 
    lcd_puts("LAWAN JARUM JAM"); 
    lcd_gotoxy(0,1); 
    lcd_putsf("N"); 
    lcd_gotoxy(2,1); 
    ftoa(potensio,0,temp1); 
    lcd_puts(temp1); 
    lcd_gotoxy(7,1); 
    lcd_putsf("1N=0"); 
    lcd_gotoxy(12,1); 
...
void putarsearahjarumjam(){ 
    ...
    OCR1A = potensio; 
    lcd_gotoxy(0,0); 
    lcd_puts("ARAH JARUM JAM"); 
    lcd_gotoxy(0,1); 
    lcd_putsf("N"); 
    lcd_gotoxy(2,1); 
    ftoa(potensio,0,temp); 
    lcd_puts(temp); 
    lcd_gotoxy(7,1); 
    lcd_putsf("1N=1"); 
    lcd_gotoxy(12,1); 
...
// Timer Period: 21.845 ms
// Output Pulse(s):
// OC1A Period: 21.845 ms Width: 16.379 ms

...
_0x0:
	...
	.DB  0x6D,0x0,0x46,0x69,0x73,0x69,0x6B,0x61
	.DB  0x20,0x49,0x6E,0x73,0x74,0x72,0x75,0x6D
	.DB  0x65,0x6E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 008C // RS - PORTB Bit 0
; 0000 008D // RD - PORTB Bit 1
; 0000 008E // EN - PORTB Bit 2
; 0000 008F // D4 - PORTB Bit 4
; 0000 0090 // D5 - PORTB Bit 5
; 0000 0091 // D6 - PORTB Bit 6
; 0000 0092 // D7 - PORTB Bit 7
...
; 0000 009B         lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009C         lcd_putsf("Fisika Instrumen");
	__POINTW2FN _0x0,10
	RCALL _lcd_putsf
; 0000 009D       }
	RJMP _0x3
